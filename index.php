...
<body>
    ...
    <header class="header-1 scroll-header" id="header">
        <nav class="nav bd-container">
           <a href="" class="nav_logo">Tasty</a>
           ...
           <div class="nav_menu" id="nav-menu">
            ...
            <ul class="nav_list">
                ...
                <li class="nav_item"><i class='bx bx-moon change-theme' id="theme-button"></i></li>
            </ul>
    ...
    <main class="main-1">
       <section class="home" id="home">
           <div class="home_container bd-container bd-grid">
               <div class="home_data">
                   <h1 class="home_title">Tasty food</h1>
                   <h2 class="home_subtitle">Try the best food of <br> the week.</h2>
                   <a href="#" class="button">View Menu </a>
               </div>

               <img src="img/home.png" alt="Home image" class="home_img">
           </div>
       </section>
       ...
       <section class="about section bd-container" id="about">
           <div class="about_container bd-grid">
               <div class="about_data">
                   ...
                   <h2 class="section-title about_initial">We cook best <br> tasty food</h2>
                   <p class="about_description"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi aut cupiditate enim minima dignissimos, Quibusdam.</p>
                  <a href="#" class="button">Explore history</a>
                </div>
                <img src="img/about.jpg" alt="about image" class="about_img">
           </div>
       </section>
       ...
       <section class="services section bd-container" id="services">
           ...
           <div class="services_container bd-grid">
               <div class="services_content">
                <svg xmlns="http://www.w3.org/2000/svg" class="services_img">
                ...
                <h3 class="services_title">Excellent food</h3>
                <p class="services_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed quibusdam, optio similique libero fugiat non praesentium tempore eveniet
                     voluptatem illum totam debitis aliquam corrupti expedita?</p>
               </div>
               <div class="services_content">
                ...
                <h3 class="services_title">Fast food</h3>
                <p class="services_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed quibusdam, optio similique libero fugiat non praesentium tempore eveniet
                     voluptatem illum totam debitis aliquam corrupti expedita?</p>
               </div>
               <div class="services_content">
                ...
                <h3 class="services_title">Delivery</h3>
                <p class="services_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed quibusdam, optio similique libero fugiat non praesentium tempore eveniet
                     voluptatem illum totam debitis aliquam corrupti expedita?</p>
               </div>
           </div>
       ...
       <section class="menu section bd-container" id="menu">
           ...
           <div class="menu_container bd-grid">
               <div class="menu_content">
                   <img src="img/plate1.png" alt="" class="menu_img">
                   <h3 class="menu_name">Barbecue salad</h3>
                   <span class="menu_detail">Delicious dish</span>
                   <span class="menu_preci">$22.00</span>
                   <a href="#" class="button menu_button">
                    <i class='bx bx-cart-alt'></i>
                   </a>
               </div>

               <div class="menu_content">
                <img src="img/plate2.png" alt="" class="menu_img">
                <h3 class="menu_name">Salad with fish</h3>
                <span class="menu_detail">Delicious dish</span>
                <span class="menu_preci">$12.00</span>
                <a href="#" class="button menu_button">
                 <i class='bx bx-cart-alt'></i>
                </a>
            </div>
            ...
            <div class="menu_content">
                <img src="img/plate3.png" alt="" class="menu_img">
                <h3 class="menu_name">Barbecue salad</h3>
                <span class="menu_detail">Spnach dish</span>
                <span class="menu_preci">$9.00</span>
                <a href="#" class="button menu_button">
                 <i class='bx bx-cart-alt'></i>
                </a>
            </div>
       ...
       <section class="section app bd-container">
           <div class="app_container bd-grid">
               <div class="app_data">
                   <span class="section-subtitle">App</span>
                   <h2 class="section-title app_initial">App is avaible</h2>
                   <p class="app_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit omnis
                        commodi dolorum eos velit consequatur.</p>
                        <div class="app_stores">
                            <a href="#"><img src="img/app1.png" alt="" class="app_store"></a>
                            <a href="#"><img src="img/app2.png" alt="" class="app_store"></a>
                        </div>
               </div>
               <img src="img/movil-app.png" alt="" class="app_img">
           </div>
       </section>
       ...
       <section class="contact section bd-container" id="contact">
           <div class="contact_container bd-grid">
               <div class="contact_data">
                ...
                <p class="contact_description contact_initial">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam hic ea rem enim 
                    excepturi quis consequatur velit doloremque facilis quidem!</p>
               </div>
    ...
    <footer class="footer section bd-container">
        ...
        <div class="footer_container bd-grid">
            <div class="footer_content">
                <a href="" class="footer_logo">Tasty Food</a>
                <span class="footer_description">Restaurant</span>
        ...
        <p class="footer_copy">&#169; 2021 Chadonet. All right reserved.</p>
    </footer>
